        ...
        <div class="info">
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div v-if="ifReady">
                            <form v-on:submit.prevent="editMayor">
                                ...
                                <button type="button" class="btn btn-success btn-sm" @click.prevent.default="updateIntro">Update Intro</button>
                            </form>
                        </div>
                        <div v-else>
    ...
    export default {
        ...
        mounted() {
            let promise = new Promise ((resolve, reject) => {
                axios.get('/api/intro').then(res => {
                    this.id             = res.data.intro.id;
                    this.name           = res.data.intro.name;
                    this.currentImage   = res.data.intro.image;
                    tinyMCE.activeEditor.setContent(res.data.intro.body);
        ...
        methods: {
            updateIntro() {
                ...
                axios.post('/api/intro/' + this.id, formData).then(res => {
                    this.$router.push({
                        name: 'intro.index',
                    });
                }).catch(err => {
